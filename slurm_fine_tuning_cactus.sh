#!/bin/bash
#SBATCH --job-name=PatientDoctorSim-FineTuning           # Job name
...
export LANG=C.UTF-8
python fine_tuning.py --mode train --dataset cactus --num-train-epochs 3 --windows 5 \
--train-frac 0.90 --no-early-stopping --output-base models_3e/qwen-cactus-therapist
