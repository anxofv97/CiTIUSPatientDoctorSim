...
export LANG=C.UTF-8
python fine_tuning.py --mode train --dataset cactus --num-train-epochs 1 --windows 5 \
--train-frac 0.90 --no-early-stopping --require-full-window --output-base models_1e/qwen-cactus-therapist
